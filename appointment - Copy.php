...
<head>
	...
	<SCRIPT language="JavaScript" src="assets/js/sanjivanicc_appointment.js" type="text/javascript"></SCRIPT>
	<?php
			...
			<div class="container">
				<div class="row rs-vertical-middle">
					<div class="col-lg-3 col-sm-3 col-md-4">
						<div class="logo-part">
							<a href="index.html"><img src="https://sanjivanicancercentre.com/media/shop-167/sanjivani-cancer-centre/sanjivani-cancer-centre-5b45de.png" style="background: white; border-radius: 5px;" alt="logo"></a>
						</div>
					</div>
		...
		<div class="container">
			<div class="content-part text-center">
				<div class="sec-title mb-30">
					<h2 class="title pb-15"> Appointment Form </h2>
				</div>
				<div class="home-appointment">
					...
					<form id="contact-form" action="https://www.midsupport.com/php/TestResult_attach.html" method="post" name="Enquiry" onSubmit="return onSubmit()"  enctype ="multipart/form-data">
							...
							<input name="subject" type="hidden" value="Appointment From Website">
							<div class="row">
							<div class="col-lg-12 mb-20 col-xs-12">
								<div class="select-option">
									<select class="from-control" name="clinic_location">
										<option selected="selected" disabled="disabled" value="">Select Preferred Clinic Location</option>
							...
							<div class="col-lg-12 col-xs-12 mb-20">
								<textarea class="from-control" id="requirement_details" name="requirement_details" placeholder="Your Message ..."></textarea>
							</div>
