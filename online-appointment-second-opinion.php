			...
			<div class="content-part text-center">
				...
				<div class="home-appointment">
					<div id="form-messages"></div>
					 ...
					 <form action="TestResult_attach_captcha_code.html" method="post" name="Enquiry" onSubmit="return onSubmit()" enctype ="multipart/form-data">
