...
if($_POST['from'] !='' && $_POST['subject']!='' && $_POST['Address']!='' && $_POST['telNo']!='' && $_POST['contact_person']!=''){
...
$dummy_content4 ="https://lotsofadsposted4u.myvnc.com";
$dummy_content5 ="earn cash online";
$dummy_content6 ="https://moreadsposted.sytes.net";
...
$dummy_content12="https://simpleseosolutions.xyz";
...
$dummy_content30 = "https://www.talkwithcustomer.com";
$dummy_content31 = "https://liveserveronline.com/talkwithcustomer.aspx?d=datarnutra.in";
...
$dummy_content37 = "https://www.postonthousandsofsites.xyz";
...
$dummy_content40 = "https://bit.ly/unlimitedwebtrafficandfreesite";
...
$dummy_content49 = "https://bit.ly/unlimitedwebtrafficandfreesite";
...
$WebsiteUrl ="https://".$_POST[website];
}
...
//$headers .= "Bcc: enquiry@mahapage.com\n";
				...
				if($ref_url == 'www.akshatautomation.com'){
					...
					{		
						...
						if ($countHref === false)
						{
							$countHref			 = strpos($address,"https://");
						}
						if ($countHref === false)
						{
						...
						if ($countHref === false)
						{
							$countHref			 = strpos($_POST[requirement_details],"https://");
						}
...
//'--
	...
	{		
		...
		if ($strmessage =="")
		{
			...
			// 							have difficulties viewing this mail,&nbsp;<a target="_blank" href="https://demo.mahapage.com/mid/midnewsletter.htm">click 
			// 							here</a></font></td>
			// 						</tr>
			// 						<tr>
			...
			// 									<td width="49">&nbsp;</td>
			// 									<td>
			// 									<img border="0" src="https://demo.mahapage.com/mid/mid-newsletter-header.jpg" width="667" height="136"></td>
			// 								</tr>
			// 							</table>
			// 							</td>
			// 						</tr>
...
$str_str=str_replace("https://","",$WebsiteUrl);

$str_opp=split("/",$str_str);	

$str_new_catalog_path="https://".$str_opp[0]."/".$str_opp[1]."/".$str_opp[2];
			
?>
<META HTTP-EQUIV=Refresh CONTENT="5; URL='<?=$str_new_catalog_path?>'">
<? } else {?>
<META HTTP-EQUIV=Refresh CONTENT="5; URL='https://<?=$Website[2]?>'">
<?}?>
